document.addEventListener('DOMContentLoaded', () =>{
    ...
    function rotate() {
        undraw()
        currentRotation ++
        if(currentRotation === current.length) { //if the current gets to 4, make it go back to 0
            currentRotation = 0
        }
        current = theTetrominoes[random][currentRotation]
        draw()
    ...
    //display upcoming tetromino in mini-grid
    ...
    const upNextTetrominoes = [
        [displayWidth+2, displayWidth*2+2, displayWidth*3+1, displayWidth*3+2], //lTetromino
